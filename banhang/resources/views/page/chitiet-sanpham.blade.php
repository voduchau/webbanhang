...
<div class="container">
    <div id="content">
        <div class="row">
            <div class="col-sm-9">
                @foreach($chitiet as $chitiets)
                <div class="row">
                    <div class="col-sm-4">
                        <img src="source/image/product/{{$chitiets->image}}" alt="">
                    </div>
                    <div class="col-sm-8">
                        <div class="single-item-body">
                            <p class="single-item-title">{{$chitiets->name}}</p>
                            <p class="single-item-price">
                                @if($chitiets->promotion_price!=0)
                                <span class="flash-sale">${{number_format($chitiets->promotion_price)}}</span>
                                @else
                                <span class="flash-sale">${{number_format($chitiets->unit_price)}}</span>
                                @endif
                            </p>
                        </div>
