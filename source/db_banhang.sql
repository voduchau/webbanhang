...
ALTER TABLE `bill_detail`
  ADD CONSTRAINT `product_id_bill_detail_foreign` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`);
ALTER TABLE `bill_detail`
  ADD CONSTRAINT `bill_id_foreign` FOREIGN KEY (`id_bill`) REFERENCES `bills` (`id`);
ALTER TABLE `bills`
  ADD CONSTRAINT `customer_id_foreign` FOREIGN KEY (`id_customer`) REFERENCES `customer` (`id`);
